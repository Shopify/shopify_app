...
module ShopifyApp
  class JWTTest < ActiveSupport::TestCase
    ...
    test "#shopify_domain and #shopify_user_id are nil if 'aud' claim doesn't match api_key" do
      expect_jwt_error(::ShopifyApp::Errors::InvalidAudienceError, "'aud' claim does not match api_key")
    ...
    test "#shopify_domain and #shopify_user_id are nil if `dest` is not a valid shopify domain" do
      expect_jwt_error(::ShopifyApp::Errors::InvalidDestinationError, "'dest' claim host not a valid shopify host")
    ...
    test "#shopify_domain and #shopify_user_id are nil if `iss` host doesn't match `dest` host" do
      expect_jwt_error(::ShopifyApp::Errors::MismatchedHostsError, "'dest' claim host does not match 'iss' claim host")
